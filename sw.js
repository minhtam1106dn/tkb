...
const ASSETS = [
  './', './index.html', './checklist.js', './dashboard.js', './leaderboard.js', './snack-fund.js', './auth-sync.js', './cloud-config.js', './checklist.css', './theme-refactor.css', './images.jpeg', './assets/characters/khoi.png', './assets/characters/khoi-avatar.png', './assets/characters/nhan.png', './manifest.webmanifest',
